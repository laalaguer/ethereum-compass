:github_url: https://github.com/laalaguer/ethereum-compass/blob/master/ch1/born.rst

简史
===========================

2009年1月3日 **比特币** [#]_ [#]_ 之后的十年间，基于区块链技术的项目纷纷诞生。
市场上的公链项目早已以数千计，更不用说分布于世界各地的以万计的加密货币交易所。
...
该项目流通的加密货币称为以太币 (Ether)，是全球第二大仅次于比特币的流通加密货币。
它的最大的特色是具有一个运行时环境：以太坊虚拟机 (Ethereum Virtual Machine,简称 **EVM**)，
为大规模分布式开放应用提供了运行的平台。
